...
**Data:** Statistical Modelling \| Spatial Data Analysis \| Biologging Data \| R \| Shiny \| QGIS \| GitHub

**Writing:** Scientific \| Technical Reports \| Public Communication

**Interpersonal:** Stakeholder Engagement \| Collaboration



## Education

**PhD Biological Sciences, University of Exeter, 2019-2022** (Corrections accepted: Jan 2023)
...
-   Recalculation of avoidance rates in R and sensivity analysis to test the effect of various input parameters.
-   Updated avoidance rates were included in a technical report and results explained to marine scientist and windfarm industry stakeholders.

**2022/23: Research Officer, Wildfowl and Wetland Trust** (October 2022 -- To Date) - Publish work carried out during my PhD in scientific journals.\
...
- Machine learning analysis, e.g. classifying accelerometer data using random forests. o Spatial data manipulation and analysis in QGIS and R (using sf package). 
...
- Differing drivers of decline within a metapopulation has implications for future conservation. University of Lund. October 22. (Invited seminar talk)

- Remotely understanding population decline in a high-arctic nesting goose. University of Exeter, Centre for Ecology and Conservation symposium. March 2021. (Talk)

-	Differing demographic drivers of low reproductive success within a high artic migrant meta-population. BOU avian reproduction conference. April 2022. (Poster)

-	Attended online conferences: BOU birds and people, 2021 & International biologging symposium, 2021
